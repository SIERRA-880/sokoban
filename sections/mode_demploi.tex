...
et \path{build/resources/main/appdata/movements}. Et va ecrire un fichier de sortie dans \path{build/resources/main/levels/save} \\
Premier argument - \textbf{map} La map au format \path{.xsb} \\
Second argument - \textbf{mov} Le fichier de movements au fornat \path{.mov} \\
