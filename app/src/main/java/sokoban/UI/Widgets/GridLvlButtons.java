...
public class GridLvlButtons extends GridPane {
    ...
    private String nom_button_selected = "build/resources/main/textures/Default/Buttons/levelMenu/levelButton_";
    private String nom_button_unselected = "build/resources/main/textures/Default/Buttons/levelMenu/levelButtonOver_";
            ...
            for (int j = 0; j < 5; j++) {
                ...
                if (lock[a - 1] == a) {
                    ...
                    button.setOnAction(e -> {
                        ...
                        lvlscene.setOnKeyPressed(event -> lvlscene.addKeyHandler(lvlscene, finalButton.player, finalButton.world, event));
